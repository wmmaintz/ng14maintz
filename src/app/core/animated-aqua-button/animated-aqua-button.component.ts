...
// https://codepen.io/simeydotme/details/MWXxKrP


@Component({
  selector: 'm-animated-aqua-button',
  templateUrl: './animated-aqua-button.component.html',
  styleUrls: ['./animated-aqua-button.component.scss']
})
export class AnimatedAquaButtonComponent implements OnInit {
